 ...
 */
public class Main {
    public static void main(String[] args) throws IOException, EspressoProjectCompilationFailedException, InterruptedException, URISyntaxException {
        ...
        buildHandler.createFatJarFromBuildDirectory();
    }
}